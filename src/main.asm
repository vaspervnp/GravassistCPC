...
; ΤΟ ΣΕΤ ΑΙΘΟΥΣΩΝ, ΣΕ ΚΑΝΟΝΙΚΗ ΜΝΗΜΗ.
;
; Έζησε για λίγο στη μνήμη οθόνης, όταν τα αχρησιμοποίητα καρέ του ήρωα
; έτρωγαν όλη τη RAM. Ήταν αναγκαστικό, όχι καλύτερο: εκεί ο buffer
; καταστρεφόταν από την πρώτη σχεδίαση, οπότε το set_cur έπαυε να λειτουργεί
; ως κρυφή μνήμη και κάθε πόρτα ξαναφόρτωνε — σε μηχάνημα 64K, μια διαβασιά
; δίσκου την ώρα που περνάς. Και άφηνε τέσσερις δείκτες που ΔΕΝ επιτρεπόταν
; ποτέ να δείξουν ξανά σε οθόνη, δηλαδή μια σιωπηλή παγίδα για το επόμενο
; feature.
;
; ΣΤΑΘΕΡΟ ΜΕΓΕΘΟΣ, όχι «ό,τι περισσεύει»: το slot_copy φέρνει set_capacity
...
; κάθε διάβασμα ρίγωνε την εικόνα υποδοχής ενώ γέμιζαν οι τράπεζες.
cas_buffer      ds   2048
                assert cas_buffer+2048 <= MEM_CEIL
