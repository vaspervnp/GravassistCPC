...
hu_td:          ld   (h_td),a
                ...
                ; ΣΒΗΣΙΜΟ ΠΡΙΝ ΤΗΝ ΚΙΝΗΣΗ, στην ΠΑΛΙΑ θέση. Ο ήρωας σβήνεται
                ; και ζωγραφίζεται σε ένα πέρασμα γιατί η περιοχή του είναι μία·
                ; το βέλος κάνει έξι pixel ανά καρέ, οπότε παλιά και νέα θέση
                ; είναι δύο ξεχωριστά ορθογώνια. Το arrow_draw έρχεται μετά τον
                ; ήρωα, στο main.asm.
                call arrow_erase
                call turret_step
