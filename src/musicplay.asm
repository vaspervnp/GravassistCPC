...
;---------------------------------------------------------------------
; drums_step — μία προσπάθεια· καλείται μία φορά ανά καρέ του παιχνιδιού
;
;   ΕΝΑ κανάλι, όχι τρία: ο βρόχος του παιχνιδιού δεν χωράει ήδη σε καρέ των
;   50 Hz, και κάθε SOUND_QUEUE κοστίζει. Το marching pattern χωράει σε ένα
;   γιατί μπάσο και ταμπούρο δεν χτυπούν ποτέ ταυτόχρονα.
; ΑΛΛΟΙΩΝΕΙ: τα πάντα
;---------------------------------------------------------------------
drums_step:     ld   hl,mus_p_drums
                ld   a,MUS_DRUMS_CH
                ld   (snd_chan),a
                ld   a,MUS_DRUMS_NZ
                ld   (snd_noise),a
