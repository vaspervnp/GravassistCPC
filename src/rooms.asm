...
; Γραφικά: 34 τύποι x 8 γραμμές x 2 bytes (MODE 1)
tile_gfx:
                ; 0 EMPTY
                db #00,#00
                db #00,#00
...
tile_props:     db #00,#01,#01,#01,#01,#01,#03,#03,#03,#03,#21,#21,#21,#21,#08,#11,#40,#04,#04,#04,#01,#01,#40,#40,#40,#00,#00,#00,#00,#40,#01,#01,#01,#01

; Η φορά που 'κοιτάει' κάθε κατευθυντικός τύπος· #FF = άσχετο.
tile_facing:    db 255,255,255,255,255,255,4,2,0,6,4,2,0,6,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255
