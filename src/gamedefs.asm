...
SET_COUNT       equ 8          ; πόσα σετ ψάχνει η εκκίνηση
...
; ΠΡΟΣΩΡΙΝΟ: 24 και όχι 64. Ο πίνακας βαθμολογιών και η μπάρα
; φόρτωσης πήραν την τελευταία RAM και ο set_buf έπεσε κάτω από τη
; μεγαλύτερη αίθουσα. Το ημερολόγιο είναι το μόνο που μικραίνει
; χωρίς να σπάσει κάτι — αλλά με 24 αλλαγές κελιών σε ΟΛΗ την
; παρτίδα, τα pickups αρχίζουν να ξαναγεννιούνται όταν γυρίσεις.
; Επιστρέφει στο 64 μόλις ο set_buf φύγει από την κύρια μνήμη.
JOURNAL_MAX     equ 24
