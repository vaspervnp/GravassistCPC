...
;   ΑΛΛΟΙΩΝΕΙ: AF, HL       (BC, DE διατηρούνται)
;---------------------------------------------------------------------
; ΠΡΩΤΑ ΟΙ ΠΛΑΤΦΟΡΜΕΣ: είναι το μόνο υλικό που δεν ζει στο πλέγμα, και
; μπαίνοντας εδώ μέσα το βλέπουν δωρεάν ο ήρωας και τα κιβώτια. Με plat_n = 0
; το plat_solid γυρίζει σε τρεις εντολές.
solid_at:       call plat_solid
                ret  c
                call cell_at
                or   a
                ret  z                  ; T_EMPTY -> NC
