...
Προς το παρόν δείχνει επίδειξη της περιστροφής: πάνω μια σειρά αναφοράς με τον ήρωα
και στις 8 φορές βαρύτητας, και από κάτω έναν ήρωα που **γυρίζει με τα πλήκτρα**.
Τα πλήκτρα βαρύτητας είναι δύο ισοδύναμα πλέγματα 3x3 (`ESC` για έξοδο):
