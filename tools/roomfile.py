...
# Με δύο, το μεγαλύτερο σετ πέφτει κάτω από 600 bytes και μένει περιθώριο για
# το επόμενο feature αντί να σπάει το build.
#
# Το τίμημα είναι μία φόρτωση από δισκέτα κάθε δύο αίθουσες — αλλά ΜΟΝΟ σε
# μηχάνημα 64K: με τις τράπεζες όλα τα σετ είναι ήδη στη μνήμη και η πόρτα
# δεν αγγίζει τον δίσκο καθόλου (src/bank.asm).
SET_ROOMS = 2
HEADER = 3 + 1 + 1 + SET_ROOMS + 2 * SET_ROOMS          # = 9 με SET_ROOMS 2
