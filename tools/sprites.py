...
SHEETS = [
    ...
    Sheet("para45", "assets/parachute45.png", "src/gfx_para45.asm", "para45_gfx",
          parachute.W45, parachute.H45, len(parachute.FRAME_NAMES), 4,
          parachute.build_frames45, parachute.FRAME_NAMES,
