# GRAVASSIST — ελληνική έκδοση

> Το [README.md](README.md) στα αγγλικά είναι το κύριο. Αυτό εδώ είναι το αρχικό
> ελληνικό κείμενο και **μπορεί να μείνει πίσω** — μερικά σημεία του (σύνδεση
> μόνο με Google, σετ των 40 αιθουσών, «λείπουν οι πίστες και ο editor») έχουν
> ήδη ξεπεραστεί και είναι διορθωμένα μόνο στο αγγλικό.
