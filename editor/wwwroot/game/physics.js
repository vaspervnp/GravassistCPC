...
(function (D) {
  ...
  class Room {
    ...
    solidAt(px, py) {
      ...
      // ΣΤΕΡΕΗ ΑΠΟ ΠΑΝΤΟΥ, ΣΑΝ ΤΟΙΧΟΣ. Ήταν μονόδρομη — μόνο από πάνω — και
      // αυτό την έκανε ανελκυστήρα ενός άξονα: ανάποδα ο ήρωας την περνούσε
      // σαν να μην υπήρχε, ενώ ο τοίχος δίπλα της γινόταν πάτωμα.
      if (this.platforms.length && this.platAt(px, py)) return true;
      py -= D.GRID_Y0;
      if (py < 0) return true;
