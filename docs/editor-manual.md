...
| `T` | Teleporter | Sends you to another cell of the **same** room. While you stand on one, a small arrow appears in an empty cell **next to the destination**, pointing at it — so you can see where you will come out before you press. |
