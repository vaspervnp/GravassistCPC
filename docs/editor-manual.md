...
| `T` | Teleporter | Sends you to another cell of the **same** room. While you stand on one, a small arrow appears **on the destination**, showing where it will send you. |
